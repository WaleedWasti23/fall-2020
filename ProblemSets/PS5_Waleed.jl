#Worked with the help of Kasra

#First add DataFramesMeta package using "] add DataFramesMeta"
...
function ps5()
	...
	θ=glm(@formula(Y ~ Odometer + Branded), df_long, Binomial(), LogitLink())
	println(θ)
	initial_theta=coef(θ)
