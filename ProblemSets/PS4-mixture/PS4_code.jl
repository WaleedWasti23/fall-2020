...
#starting values taken from PS3
...
#startvals = [2*rand(7*size(X,2)).-1; .1] Actually done using this command but it takes long.
...
#question 2
# The coefficient is now positive which makes more sense because log wage and utility should ideally be positively related.
